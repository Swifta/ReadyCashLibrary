...
public class TerminatingExceptionException extends java.lang.Exception{
    ...
    public void setFaultMessage(com.readycashng.www.ws.api._1_0.AgentServiceServiceStub.TerminatingException msg){
       faultMessage = msg;
    }
    
    public com.readycashng.www.ws.api._1_0.AgentServiceServiceStub.TerminatingException getFaultMessage(){
       return faultMessage;
    }
}
